...
type Example2 interface {
	Insert(ctx context.Context, example2 *src.Example2) error
	...
	GetByVar7AndVar5(ctx context.Context, var7 bool, var5 int) (*src.Example2, error)
...
func (r *mysqlExample2) Insert(ctx context.Context, example2 *src.Example2) error {
	_, err := r.db.NamedExecContext(ctx, "INSERT INTO example_2 ("+
		"var5, var6, var7, var8"+
		") VALUES ("+
		":var5, :var6, :var7, :var8)",
		example2)
...
func (r *mysqlExample2) GetByVar7AndVar5(ctx context.Context, var7 bool, var5 int) (*src.Example2, error) {
	var example2 src.Example2
